...
class BookingController extends ControllerBase {
  ...
  protected function buildConfirmationStep(array $data): array {
    ...
    // Stored as UTC without offset (Y-m-d\TH:i:s), so parse as UTC first.
    $appointment_date = new DrupalDateTime($data['appointment_date'], new \DateTimeZone('UTC'));
    $site_tz = $this->config('system.date')->get('timezone.default') ?: 'UTC';
    $appointment_date->setTimezone(new \DateTimeZone($site_tz));
